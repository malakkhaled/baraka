...
<li class="has-dropdown mega-dropdown active">
    <a href="{{route('indexEN')}}"    class="  menu-item">home</a>
...
<li class="has-dropdown">
    <a href="{{route('aboutEN')}}"    class="  menu-item">About</a>
...
<!-- About Menu -->
<li class="has-dropdown">
    <a href="{{route('productEN')}}"    class="   menu-item" data-hover="pages">product</a>
   
</li>
<!-- li end -->

<li>
    <a href="{{route('newsEN')}}" class="menu-item" href="page-book-table.html">news</a>
</li>

<!-- Features Menu-->
<li class="has-dropdown" id="contact">
    <a href="{{route('contactEN')}}"    class="  menu-item">contact</a>
  
</li>

<li class="has-dropdown">
    <a href="{{route('index')}}"    class="  menu-item">Arabic language</a>
