            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="title title-1 text-center">
                    <div class="title--content">
                        <div class="title--subtitle">Stay Updated</div>
...
<!-- Blog Grid
============================================= -->
<section id="blog" class="blog blog-grid pb-80">
    <div class="container">
        <div class="row">
            <!-- Blog Entry #1 -->
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <div class="blog-entry">
                    ...
                    <div class="entry--content">
                        ...
                        <div class="entry--bio">
                            Combine the onions, flour, panko and salt in a large mixing bowl and toss to combine. Coat a sheet pan nonstick spray & evenly spread the onions.
                        </div>
                    </div>
                    <!-- .entry-content end -->
                </div>
